...
@Component({
  selector: 'embryo-ProductSuggestedGrid',
  templateUrl: './ProductSuggestedGrid.component.html',
  styleUrls: ['./ProductSuggestedGrid.component.scss']
})
export class ProductSuggestedGridComponent implements OnInit ,OnChanges {
   //@Input() 
